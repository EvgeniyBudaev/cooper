...
const ALLOWED_CONTENT_TYPES = ["image/png", "image/jpeg", "image/gif", "image/svg+xml", "image/webp"];
const ALLOWED_HOSTS = ["image.shutterstock.com", "assets.coingecko.com", "www.semashko.com"];
...
export const loader: LoaderFunction = async ({ params }) => {
  ...
  return new Response(response.body, {
    headers: Object.fromEntries(COPIED_HEADERS.flatMap(header => {
